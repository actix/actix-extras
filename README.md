...
| [tracing-actix-web-opentelemetry] | [![crates.io](https://img.shields.io/crates/v/tracing-actix-web-opentelemetry?label=latest)][tracing-actix-web-opentelemetry] [![dependency status](https://deps.rs/crate/tracing-actix-web-opentelemetry/latest/status.svg)](https://deps.rs/crate/tracing-actix-web-opentelemetry) | OpenTelemetry adapter for tracing-actix-web.                                    |
...
[tracing-actix-web-opentelemetry]: https://crates.io/crates/tracing-actix-web-opentelemetry
