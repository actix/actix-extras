...
clippy:
    ...
    cargo {{ toolchain }} clippy -p tracing-actix-web --lib --tests --examples --bins --features opentelemetry_0_33
...
test-docs:
    ...
    cargo {{ toolchain }} check -p tracing-actix-web --all-targets --features opentelemetry_0_33
...
ci-test-tracing-actix-web:
    ...
    cargo {{ toolchain }} test -p tracing-actix-web --lib --tests --examples --bins --no-fail-fast --features opentelemetry_0_33
...
doc *args: && doc-set-workspace-crates
    ...
    RUSTDOCFLAGS="--cfg=docsrs -D warnings" cargo +nightly doc -p tracing-actix-web --no-deps --features "uuid_v7 opentelemetry_0_33" {{ args }}
