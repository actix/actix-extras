...
- Update the `actix` dependency to 0.11.0-beta.1
- Update the `actix-utils` dependency to 3.0.0-beta.1
- Update the `futures-util` dependency to 0.3.9
- Update the `tokio` dependency to 1.0
- Update the `tokio-util` dependency to 0.6
- Update the `actix-service` dependency to 2.0.0-beta.2
- Use locale version of `actix-session´ for now
- Update the `rand` dependency to 0.8.1
- Update the `env_logger` dependency to 0.8
- Update the `time` dependency to 0.2.23
- Update the `serde` dependency to 1.0.101
- Update the `serde_json` dependency to 1.0.61
