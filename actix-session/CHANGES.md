...
### Added
- `TtlExtensionPolicy`, to support different strategies for extending the TTL attached to the session state. [#233]
...
- The fields for Both `SessionLength` variants have been extracted into separate types (`PersistentSession` and `BrowserSession`). [#233] 
